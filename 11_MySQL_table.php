...
$insertQuery = "INSERT INTO users (name, email, gender, date_of_birth, salary) VALUES
...
echo $result ? "Database operation done successfully" : die("Database operation  failed >> " . mysqli_error($connection));
